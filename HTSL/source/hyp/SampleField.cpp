...
: _xSize(0), _ySize(0)
{
	_kernel = std::bind(hyp::kernelSquaredExponential, std::placeholders::_1, std::placeholders::_2, 10.0f);
}
...
float hyp::kernelSquaredExponential(const std::vector<float> &x1, const std::vector<float> &x2, float invThetaSquared) {
