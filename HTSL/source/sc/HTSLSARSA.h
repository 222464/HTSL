...
namespace sc {
	...
	public:
		...
		HTSLSARSA()
			: _prevValue(0.0f), _prevNewQ(0.0f), _actionRandomizeChance(0.1f), _actionPerturbationStdDev(0.1f),
			_qAlpha(0.002f), _qGamma(0.992f), _qTraceDecay(0.01f), _actionAlpha(0.002f), _actionBeta(0.5f), _actionTraceDecay(0.01f), _actionTraceTemperature(4.0f)
		{}
