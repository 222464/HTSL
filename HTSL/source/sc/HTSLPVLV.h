...
namespace sc {
	...
	public:
		...
		HTSLPVLV()
			...
			_expectedAlpha(1.0f), _secondaryAlphaE(1.0f), _secondaryAlphaI(0.1f), _thetaMin(0.49f), _thetaMax(0.51f)
		{}
		...
		void update(float reward, std::mt19937 &generator, bool linearFirstLayer = false);
