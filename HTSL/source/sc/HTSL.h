	...
	public:
		struct LayerDesc {
			...
			LayerDesc()
				...
				_rscAlpha(0.2f), _rscBetaVisible(0.1f), _rscBetaHidden(0.1f), _rscGamma(0.05f), _rscNoveltyPower(8.0f), _rscLearnTolerance(0.001f), _rscMinLearnTolerance(0.0001f),
				_nodeAlphaLateral(0.1f), _nodeAlphaFeedback(0.2f), _nodeBiasAlpha(0.05f), _attentionAlpha(0.5f), _hiddenUsageDecay(0.02f), _lowUsagePreference(4.0f)
			{}
		};
