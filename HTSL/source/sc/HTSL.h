	...
	public:
		struct LayerDesc {
			...
			LayerDesc()
				...
				_rscAlpha(0.4f), _rscBetaVisible(0.1f), _rscBetaHidden(0.1f), _rscDeltaVisible(0.0f), _rscDeltaHidden(0.0f), _rscGamma(0.3f), _rscLearnTolerance(0.01f), _rscMinLearnTolerance(0.0f),
