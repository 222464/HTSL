	...
	public:
		struct LayerDesc {
			...
			LayerDesc()
				...
				_rscAlpha(0.8f), _rscBetaVisible(0.1f), _rscBetaHidden(0.1f), _rscDeltaVisible(0.01f), _rscDeltaHidden(0.01f), _rscGamma(0.01f), _rscLearnTolerance(0.01f), _rscMinLearnTolerance(0.0f),
				_nodeAlphaLateral(0.1f), _nodeAlphaFeedback(0.1f), _nodeBiasAlpha(0.1f), _attentionAlpha(0.5f), _hiddenUsageDecay(0.02f), _lowUsagePreference(0.0f)
			{}
		};
