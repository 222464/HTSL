...
namespace sc {
	...
	public:
		...
		HTSLQ()
			: _prevValue(0.0f), _prevMax(0.0f), _prevNewQ(0.0f), _prevTdError(0.0f), _actionRandomizeChance(0.05f), _actionPerturbationStdDev(0.05f),
			_qAlpha(0.001f), _qGamma(0.992f), _qTraceDecay(0.01f), _actionAlpha(0.01f), _actionBeta(1.0f), _actionTraceDecay(0.05f), _actionTraceTemperature(5.0f),
			_actionAverageDecay(1.0f), _actionWeightDetermineAlpha(0.01f), _tauInv(30.0f)
		{}
